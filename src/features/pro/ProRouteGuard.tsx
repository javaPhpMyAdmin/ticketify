 ...
 * Mounting inside the screen keeps the locked/unlocked decision local
 * to the content and lets the screen keep its own layout (header,
 ...
 * is genuinely free — it renders `<ProLock />`. When the state flips
 * to `'unlocked'` it renders `children` instead, so a successful
 * purchase / restore re-renders the screen with the real content
 ...
 * renders `children` in place. The route is still mounted in both
